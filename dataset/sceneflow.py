...
class SceneFlowDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        data = {
            "left": np2torch(cv2.imread(str(left_path), cv2.IMREAD_GRAYSCALE)),
            "right": np2torch(cv2.imread(str(right_path), cv2.IMREAD_GRAYSCALE)),
...
if __name__ == "__main__":
    ...
    dataset = SceneFlowDataset(
        ...
        "/media/rvcse22/CSERV/cse/stereo_depth_datasets/MAINDS_FLY_TH_3D",
        training=True,
    )
