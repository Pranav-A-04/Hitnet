...
--data_root_train /media/rvcse22/CSERV/cse/stereo_depth_datasets/MAINDS_FLY_TH_3D \
--data_list_train lists/sceneflow_train_fly3d_only.list \
--data_size_train 960 320 \
--data_type_val SceneFlow \
--data_root_val /media/rvcse22/CSERV/cse/stereo_depth_datasets/MAINDS_FLY_TH_3D \
